...
-- Item
    ...
    INSERT INTO item (name, `desc`, price, image_url, category_id) VALUES
...
-- Orders
    ...
    INSERT INTO orders (table_id, total, pax) VALUES (4, 10.0, 2);
    INSERT INTO orders (table_id, total, pax) VALUES (5, 4.4, 2);
...
-- Order Details
    ...
    INSERT INTO order_details (order_id, item_id, quantity) VALUES (2, 3, 1);
    INSERT INTO order_details (order_id, item_id, quantity) VALUES (2, 3, 1);
