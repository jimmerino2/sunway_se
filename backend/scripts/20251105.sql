...
-- Order Orders
    ...
    INSERT INTO orders (item_id, table_id, quantity, status) VALUES (1, 1, 1, 'D');
    INSERT INTO orders (item_id, table_id, quantity, status) VALUES (2, 1, 1, 'D');
    INSERT INTO orders (item_id, table_id, quantity, status) VALUES (3, 1, 1, 'D');
    INSERT INTO orders (item_id, table_id, quantity, status) VALUES (3, 1, 1, 'D');
    INSERT INTO orders (item_id, table_id, quantity, status) VALUES (4, 1, 2, 'D');
    INSERT INTO orders (item_id, table_id, quantity, status) VALUES (4, 1, 2, 'D');
