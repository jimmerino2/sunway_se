...
(1, 1, 1, 1, 'D', 'Y', '2025-11-07 10:57:45'),
(2, 2, 1, 1, 'D', 'Y', '2025-11-07 10:57:45'),
(3, 3, 1, 1, 'D', 'Y', '2025-11-07 10:57:45'),
(4, 3, 1, 1, 'D', 'Y', '2025-11-07 10:57:45'),
(5, 4, 1, 2, 'D', 'Y', '2025-11-07 10:57:45'),
(6, 4, 1, 2, 'D', 'Y', '2025-11-07 10:57:46'),
...
(13, 10, 5, 2, 'D', 'Y', '2025-11-01 12:00:00'),
(14, 11, 6, 3, 'D', 'Y', '2025-11-02 13:00:00'),
(17, 1, 9, 1, 'D', 'Y', '2025-10-10 08:30:00'),
(18, 4, 10, 2, 'D', 'Y', '2025-10-25 12:00:00'),
(21, 1, 1, 1, 'D', 'Y', '2024-11-05 10:15:00'),
...
CREATE TABLE `seating` (
  ...
  CONSTRAINT chk_floor_type CHECK (
      (`floor` = 1 AND `type` IN ('Private Room', 'Solo Work Bar', 'Group Work Table', 'Lounge')) OR
      (`floor` = 2 AND `type` IN ('Minibar', 'Open Dining')) OR
      (`floor` = 3 AND `type` IN ('Open Dining'))
  ),
  
  CONSTRAINT chk_type_ttype CHECK (
      (`type` = 'Private Room'     AND `ttype` IN ('Long Table')) OR
      (`type` = 'Solo Work Bar'    AND `ttype` IN ('Bar Stool')) OR
      (`type` = 'Group Work Table' AND `ttype` IN ('Long', 'Round', 'Square')) OR
      (`type` = 'Lounge'           AND `ttype` IN ('Sofa', 'Stool')) OR
      (`type` = 'Minibar'          AND `ttype` IN ('Bar Stool')) OR
      (`type` = 'Open Dining'      AND `ttype` IN ('Long', 'Round', 'Square'))
  )
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 2, 'F', 'Lounge', 'Sofa', 1),
(3, 3, 'F', 'Lounge', 'Stool', 1),
(4, 4, 'F', 'Solo Work Bar', 'Bar Stool', 1),
(5, 5, 'F', 'Group Work Table', 'Long', 1),
(6, 6, 'F', 'Group Work Table', 'Round', 1),
(7, 7, 'F', 'Group Work Table', 'Square', 1),

-- Floor 2
(8, 8, 'F', 'Minibar', 'Bar Stool', 2),
(9, 9, 'F', 'Open Dining', 'Long', 2),
(10, 10, 'F', 'Open Dining', 'Round', 2),
(11, 11, 'F', 'Open Dining', 'Square', 2),

-- Floor 3 (Open Dining only)
(12, 12, 'F', 'Open Dining', 'Long', 3),
(13, 13, 'F', 'Open Dining', 'Round', 3),
(14, 14, 'F', 'Open Dining', 'Square', 3);
