                                    ...
                                    <div class="row d-flex h-100">
                                        <div class="col-md-3 d-flex flex-column">
                                            ...
                                            <div class="room d-flex flex-column">
                                                <div class="community-table-group clickable-seat" data-table-id="T33">
                                                ...
                                                <div class="community-table-group clickable-seat" data-table-id="T34">
                                                    <div class="community-table">
                                                        <div class="chair" style="top: -15px; left: 15%;"></div>
                                                        <div class="chair" style="top: -15px; left: 45%;"></div>
                                                        <div class="chair" style="top: -15px; left: 75%;"></div>
                                        ...
                                        <div class="col-md-9 d-flex flex-column">
                                            ...
                                            <div class="seating-zone h-100">
                                                <div class="community-table-group clickable-seat" data-table-id="T35">
                                                    <div class="community-table">
                                                        <div class="chair" style="top: -15px; left: 15%;"></div>
                                                        <div class="chair" style="top: -15px; left: 45%;"></div>
                                                        <div class="chair" style="top: -15px; left: 75%;"></div>
                                                ...
                                                <div class="community-table-group clickable-seat" data-table-id="T36">
                                                    <div class="community-table">
                                                        <div class="chair" style="top: -15px; left: 15%;"></div>
                                                        <div class="chair" style="top: -15px; left: 45%;"></div>
                                                        <div class="chair" style="top: -15px; left: 75%;"></div>
                                                ...
                                                <div class="community-table-group clickable-seat" data-table-id="T37">
                                                    <div class="community-table">
                                                        <div class="chair" style="top: -15px; left: 15%;"></div>
                                                        <div class="chair" style="top: -15px; left: 45%;"></div>
                                                        <div class="chair" style="top: -15px; left: 75%;"></div>
                                                ...
                                                <div class="community-table-group clickable-seat" data-table-id="T38">
                                                    <div class="community-table">
                                                        <div class="chair" style="top: -15px; left: 15%;"></div>
                                                        <div class="chair" style="top: -15px; left: 45%;"></div>
                                                        <div class="chair" style="top: -15px; left: 75%;"></div>
                                    ...
                                    <div class="row d-flex h-100">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="seating-zone">
                                                ...
                                                <div class="community-table-group clickable-seat" data-table-id="T52">
                                                    <div class="community-table">
                                                        <div class="chair" style="top: -15px; left: 15%;"></div>
                                                        <div class="chair" style="top: -15px; left: 45%;"></div>
                                                        <div class="chair" style="top: -15px; left: 75%;"></div>
                                                ...
                                                <div class="community-table-group clickable-seat" data-table-id="T53">
                                                    <div class="community-table">
                                                        <div class="chair" style="top: -15px; left: 15%;"></div>
                                                        <div class="chair" style="top: -15px; left: 45%;"></div>
                                                        <div class="chair" style="top: -15px; left: 75%;"></div>
                                                ...
                                                <div class="community-table-group clickable-seat" data-table-id="T54">
                                                    <div class="community-table">
                                                        <div class="chair" style="top: -15px; left: 15%;"></div>
                                                        <div class="chair" style="top: -15px; left: 45%;"></div>
                                                        <div class="chair" style="top: -15px; left: 75%;"></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const tableElementSelectors = [
                ...
                '.community-table-group .community-table',
